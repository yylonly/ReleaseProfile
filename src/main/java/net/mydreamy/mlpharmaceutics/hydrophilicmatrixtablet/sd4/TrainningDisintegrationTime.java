...
//     public static final int numHiddenNodes = 60;
	...
	public static void main(String[] args) {
        ...
        try {
        	recordReadertrain.initialize(new FileSplit(new ClassPathResource("sd4/trainSet.csv").getFile()));
        ...
        try {
        	recordReadertest.initialize(new FileSplit(new ClassPathResource("sd4/devSet.csv").getFile()));
		} catch (FileNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (IOException e) {
