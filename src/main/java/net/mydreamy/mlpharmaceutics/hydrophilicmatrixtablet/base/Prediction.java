	...
	public static void prediction(String problem, String dataset, int size, String model, boolean print) {
		  ...
		  RecordReader recordReadertest = new CSVRecordReader(1,",");
	        ...
	        switch (problem) {
	        	...
	        	case "SD-new":  iteratortest = new RecordReaderDataSetIterator(recordReadertest, size, 33, 39, true);  break;
...
//	        	case "SD-new":  Evaluation.f2(lablesTest, PredictionTest); break;
	        	...
	        	case "SD-new":  Evaluation.AccuracyMAE(lablesTest, PredictionTest, 0.15);	 break;
	        	case "SD": break;
	        }
